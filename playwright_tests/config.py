...
class Config:
    if sys.platform == "win32":  # Windows 環境
        ...
        CHROMEDRIVER_PATH = "/Users/steven/deepseek/playpytest/playwright_tests/chormedrive/chromedriver"
        RANDOM_DATA_JSON_PATH = "/Users/steven/deepseek/playpytest/playwright_tests/random_data.json"
    else:
